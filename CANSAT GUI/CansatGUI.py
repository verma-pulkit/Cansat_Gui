...
encoded_image_bags = base64.b64encode(open('/CANSAT GUI/logo.jpeg', 'rb').read())
encoded_image_flag = base64.b64encode(open('/CANSAT GUI/flag.png', 'rb').read())
encoded_image_cansat = base64.b64encode(open('/CANSAT GUI/CanSat Logo - Color.png', 'rb').read())
encoded_image_nsut = base64.b64encode(open('/CANSAT GUI/nsut_logo.png', 'rb').read())
